...
INSERT INTO public.badges (name, description, icon, criteria) VALUES
  ('First Question', 'Submitted your first question', '🎯', 'Submit 1 question'),
  ('Question Master', 'Contributed 10 approved questions', '🏆', 'Submit 10 approved questions'),
  ('Helpful Contributor', 'Received 50 upvotes', '⭐', 'Receive 50 upvotes'),
  ('Community Leader', 'Reached 1000 reputation points', '👑', 'Reach 1000 reputation'),
  ('Expert Reviewer', 'Reviewed 100 questions as admin', '🔍', 'Review 100 questions')
