...
export function DraftQuestionCard({ question, index, onUpdate, onDelete }: Props) {
      ...
      <MobileCard className="p-4 space-y-3">
        ...
        <div className="space-y-2">
          ...
          <RadioGroup
            ...
            onValueChange={(value) => setDraft({ ...draft, correct_answer: value as DraftQuestion["correct_answer"] })}
          >
  ...
  return (
    <MobileCard className="p-4 space-y-3 hover:shadow-md transition-shadow">
