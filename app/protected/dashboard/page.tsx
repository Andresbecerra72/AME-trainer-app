        ...
        {recommendations.length > 0 && (
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/protected/recommendations" className="text-sm text-primary hover:underline">
                View all
              </Link>
            </div>
        ...
        {recentQuestions && recentQuestions.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between px-1">
              ...
              <Link href="/protected/community" className="text-sm text-primary hover:underline">
                View all
              </Link>
            </div>
