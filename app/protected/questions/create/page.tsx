...
// NEW — Correct services
import { createQuestion } from "@/features/questions/services/question.api";
import { getAllTopicsClient } from "@/features/topics/services/topic.api";

// NEW — Duplicate checker
import { isDuplicateQuestion } from "@/features/questions/utils/question.helpers";
...
export default function AddQuestionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newQuestion = {
      ...
      option_c: optionC,
      option_d: optionD,
      correct_option: correctAnswer.toLowerCase(), // FIX
    ...
    try {
      // DUPLICATE CHECK
      const existing = await fetch("/api/questions/check-duplicates", {
        method: "POST",
        ...
        {mode === "Manual" && (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={correctAnswer} onValueChange={(v) => setCorrectAnswer(v as any)}>
