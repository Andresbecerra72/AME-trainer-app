...
function ActivityCard({ activity }: { activity: any }) {
  ...
  const getLink = () => {
    if (activity.type === "question") return `/protected/community/questions/${activity.id}`
    if (activity.type === "comment" && activity.questionId) return `/protected/community/questions/${activity.questionId}`
    if (activity.type === "exam") return `/protected/exams/${activity.id}`
    return "#"
  }
